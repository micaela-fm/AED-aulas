 ...
 */
fun evaluateFibonacci(identifier:String, values: Array<Int>, funFibonacci: (Int) -> Int) {
    println("----- $identifier -----")
    for ( v in values ) {
      print("$v ")
...
fun main() {
    evaluateFibonacci("fibonacci", getMultiples(5, 1920000), ::fibonacci)
    evaluateFibonacci("fibonacci with auxiliar memory", getMultiples(4, 1920000), ::fibonacciMemoryN)
    evaluateFibonacci("fibonacci recursive", getMultiples(3, 20),::fibonacciRecursive)
}
